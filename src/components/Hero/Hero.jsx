        ...
        <div>
            <div className='absolute top-16 bg-sky-50'>
                ...
                <div className='h-60 -mt-32 -z-50 '>
                    <p className='w-full pb-4 absolute text-red-600 text-center bottom-0 bg-red-100'>
                ...
                <div className=" -mt-48 mb-10 py-4 px-4 pt-16 bg-red-100 flex flex-col items-center text-center">
                    <div className='max-w-4xl text-lg px-4'>
                        <h1 className='w-full text-center text-3xl py-4 font-semibold mb-2 text-gray-700'><span className='text-red-600'>Healthify</span>  is your guide to Stay Healthy and happy 😊</h1>
                        ...
                        <p className='py-10 text-3xl text-gray-700 font-semibold'> Remember these <span className='text-red-600'>nine tips</span> to stay healthy year-round</p>
                        <ul className='list-decimal text-gray-700'>
                            <li className='hover:text-red-600'>Get active</li>
                            <li className='hover:text-red-600'>Take supplements as necessary</li>
                            <li className='hover:text-red-600'>Eat a healthy diet</li>
                            <li className='hover:text-red-600'>Wash your hands frequently</li>
                            <li className='hover:text-red-600'>Learn how to manage stress</li>
                            <li className='hover:text-red-600'>Get plenty of rest</li>
                            <li className='hover:text-red-600'>Take steps to prevent infections</li>
                            <li className='hover:text-red-600'>Schedule annual physicals</li>
                            <li className='hover:text-red-600'>Avoid contact with people who are sick</li>
                        </ul>
                    </div>
