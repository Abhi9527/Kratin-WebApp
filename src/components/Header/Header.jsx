                ...
                <div className={`${hamburger} w-full md:flex md:items-center md:w-auto justify-center`} id="menu">
                    <ul className="pt-4 text-md text-red-600 md:flex md:pt-0">
                        <li onClick={handleHamburger}>
                            <Link id="home-btn"
                                className="md:p-4 py-2 ml-2 block hover:text-red-800" to="/">Home</Link>
                        </li>
                        <li onClick={handleHamburger}>
                            <Link id="home-btn"
                                className="md:p-4 py-2 ml-2 block hover:text-red-800 " to="/diet">Diet</Link>
                        </li>
                        <li onClick={handleHamburger}>
                            <Link id="home-btn"
                                className="md:p-4 py-2 ml-2 block hover:text-red-800 " to="/yoga">Yoga & Exercise</Link>
                        </li>
                        {/* <li onClick={handleHamburger}>
                            <Link id="home-btn"
                                className="md:p-4 py-2 ml-2 block hover:text-red-800 " to="/entertainment">Entertainment</Link>
                        </li> */}
                        <li onClick={handleHamburger}>
                            <Link id="watchlist-btn" className="md:p-4 py-2 ml-2 mr-2 block hover:text-red-800"
                                to="/bmi">BMI</Link>
                        </li>
                    </ul>
                </div>
